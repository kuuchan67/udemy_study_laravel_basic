                                ...
                                <div class="flex flex-wrap -m-2">
                                    ...
                                    <div class="p-2 w-full">
                                        <div class="relative">
                                            ...
                                            <input type="radio" id="gender-0" name="gender" value="0" {{old("gender") == '0' ? "checked" : ""}}><label for="gender-0">男性</label>
                                            <input type="radio" id="gender-1" name="gender" value="1" {{old("gender") == '1' ? "checked" : ""}}><label for="gender-1">女性</label>
                                        </div>
                                    </div>
                                    <div class="p-2 w-full">
                                        <div class="relative">
                                            <label class="leading-7 text-sm text-gray-600">年齢</label><br>
                                    ...
                                    <div class="p-2 w-full">
                                        <div class="relative">
                                            <input type="checkbox" id="caution" name="caution"><label for="caution">注意事項に同意する</label>
                                        </div>
                                    </div>
