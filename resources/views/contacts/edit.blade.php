                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <input type="radio" id="gender-0" name="gender" value="0" @if($contact->gender === 0) checked @endif><label for="gender-0">男性</label>
                                                <input type="radio" id="gender-1" name="gender" value="1" @if($contact->gender === 1) checked @endif><label for="gender-1">女性</label>
                                            </div>
                                        </div>
                                        <div class="p-2 w-full">
                                            <div class="relative">
